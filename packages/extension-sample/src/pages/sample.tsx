...
const Sample = () => {
  ...
  return (
    <Fragment>
      ...
      <p>
        If you are reading this, it means that this page was successfully added
        to your base project. 🎉
      </p>
      <p>
        This <i>Application Extension</i> was installed by running the below
        command in your PWA-Kit project. Its dependancies were automatically
        installed and the extension configured into your projects extensions
        array.
      </p>
      <div
        style={{
      ...
      >
        <code>
          ...
          &gt; Finished. <br />
          &gt; Congratulations! The Sample extension was successfully installed!
          Please visit
          https://www.npmjs.com/package/@salesforce/extension-sample for more
