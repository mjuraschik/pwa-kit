...
#### Loaders 🏗️
 ...
 - `webpack/override-resolver-loader`
    ...
    3. Finally, check if file exists in the extension configured prior `node_modules/@salesforce/extension-chakra-chakra-storefront/src/overrides/pages/checkout` and do not go any further as you have reached the source importing module which is the canonical source.
