...
/**
 * Category component for Page Designer.
 * Renders a category tile with image and name.
 *
 * @param {object} props
 ...
 * @returns {React.ReactElement} - Category component.
 */
export const Category = ({category, image, categoryUrl}) => {
